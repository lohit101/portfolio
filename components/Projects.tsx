    ...
    return (
        ...
        <div className="grid grid-cols-2 w-1/2 mx-auto gap-5">
            ...
            <div className="flex items-center justify-center">
                <a href="https://github.com/lohit101" target="_blank" className="flex flex-row gap-1 items-center justify-center text-xs text-white/50 hover:text-white border border-white/20 px-4 py-1 rounded-full bg-white/10 transition-all">View all projects <ExternalLink size={12} /></a>
            </div>
        </div>
    )
}